...
class CChannel33To48 : public CDialogEx
{
	DECLARE_DYNAMIC(CChannel33To48)

public:
	CChannel33To48(CWnd* pParent = NULL);   // 标准构造函数
	virtual ~CChannel33To48();

	int IsReDraw;
	int m_Xcoor;

	// 对话框数据
	enum { IDD = IDD_DIALOG33_48 };
